...
// Define accepted file types and their validators
  ...
  const processFile = async () => {
    ...
    try {
      ...
      if (file.type.includes('audio')) {
        // For audio files, use Whisper API
        ...
        // Mock API call - in a real app, you would call the actual OpenAI API
        await new Promise(resolve => setTimeout(resolve, 2000));
        setConversionProgress(60);
        
        // Mock response - in a real app, this would be the actual API response
        const mockResponse = `This is a transcription of the audio file "${file.name}". In a real implementation, this would contain the actual transcribed text from OpenAI's Whisper API.`;
        ...
        addToHistory({
          ...
          fileType: file.type,
          fileSize: file.size,
          convertedText: mockResponse,
        });
        
      } else if (file.type.includes('pdf') || file.type.includes('word') || file.type.includes('document')) {
        // For document files (in a real implementation, you might use a different API or process)
        formData.append('file', file);
        ...
        // Mock response
        const mockResponse = `This is extracted text from the document "${file.name}". In a real implementation, this would contain the actual text extracted from the document.`;
    ...
    <div className="w-full">
      <div className="mb-6">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">
          Supported formats: MP3, WAV, PDF, DOC, DOCX (max 25MB)
        </p>
